...
final class PhoneReportApiService: PhoneReportHandling {
  ...
  func searchReports(
    ...
    do {
      return try JSONDecoder.decodeWithFlexibleISO8601(PhoneReportResponse.self, from: data)
    } catch {
  ...
  func getBy(phoneNumber: String) async throws -> PhoneReportDetails? {
    ...
    case 200:
      return try JSONDecoder.decodeWithFlexibleISO8601(PhoneReportDetails.self, from: data)
    case 404:
      return nil
    default:
      throw ReportError.serverError
